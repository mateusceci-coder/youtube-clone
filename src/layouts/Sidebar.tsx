import { Home, Repeat, Clapperboard, Library, ChevronDown, ChevronUp, PlaySquare, Clock, History, ListVideo, Flame, ShoppingBag, Film, Music2, Radio, Gamepad2, Newspaper, Trophy, Lightbulb, Shirt, Podcast } from "lucide-react"
...
const SmallSidebarItem = ({ IconOrImgUrl, title, url }: SmallSidebarItemProps) => {
